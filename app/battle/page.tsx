...
const actionDesc: Record<BattleAction, string> = {
  ...
  spell:  "Dégâts ~1.5× Frappe + perce 50% défense · 2 multiplications",
    ...
    <main className="relative space-y-3 pb-28">
      ...
      <HelpPanel open={help} title="⚔️ Combat" onClose={() => setHelp(false)}>
        ...
        <ul className="ml-4 list-disc space-y-1">
          ...
          <li><b>Sort (Concentration) :</b> 2 multiplications. Dégâts <b>~1.5× plus forts que Frappe</b> qui ignorent 50 % de la défense ennemie. Améliorée par <i>Concentration</i>. Débloqué à la Forme 2.</li>
